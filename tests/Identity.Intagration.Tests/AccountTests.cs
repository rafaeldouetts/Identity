...
{
    internal class AccountTests : IClassFixture<TestEnvironmentSetup>
    {
        private readonly HttpClient _client;

        public AccountApiTests(TestEnvironmentSetup setup)
        {
            _client = new HttpClient { BaseAddress = new System.Uri("http://localhost:5000/") };  // Endereço da API local
        }
